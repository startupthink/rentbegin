...
> **อัปเดตล่าสุด:** เพิ่มระบบอัปโหลดรูป · จอง/มัดจำ · สัญญาดิจิทัล · หน้านโยบาย
> ก่อน deploy รอบนี้ **ต้องรัน SQL 2 ไฟล์ใหม่** — ดู `SETUP-PAYMENTS.md` ข้อ 1
> (`supabase/storage.sql` และ `supabase/payments.sql`)
